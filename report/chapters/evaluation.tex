...
In short, while Confis lacks the computational capabilities of a programming language, it is not that lacking when compared to Symboleo since it does allow specifying numerical constants (except without having to specify their types).
