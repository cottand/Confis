...
TODO talk about~\cite{sartorLegalReasoning}.
...
\section{Representing human language in a machine-readable format}\label{sec:language-as-machine-readable}
...
Existing technologies trying to process legal text -- such as~\cite{angeli2015NLP1}, \cite{lapata2016NLP2}, or~\cite{lapata2018NLP3} -- try to produce normative rules.
At the time of writing, they fall short of fully capturing all relevant information in an existing legal document.
...
\subsubsection{Normative Effects and Modalities}
...
Properly capturing modalities or behaviours such as a \emph{requirement} or a \emph{permission} is a major difficulty the state of the art of Artifcial Intelligence in Law struggles to deal with~\cite{ferraroLegalNLPSSurvey}.

\subsection{Domain-Specific Languages}\label{subsec:dsls}
...
The compromises they make are in cost (for developing a framework for them), ease of writing, readability, and expressiveness.

% TODO external, internal, GUI, etc
