...
Additionally, the editor IntelliJ IDEA supports live evaluation of Koltin inside text boxes, allowing to provide hints at the same time it compiles a specific snippet of code~\cite{intelliJRepo}.
