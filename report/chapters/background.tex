...
\subsection{Contract-Driven Agents}\label{subsec:contract-driven-agents}
...
Unlike Ricardian contracts~(see~\ref{subsec:ricardian-contracts}), contract-driven agents attempt to describe the behaviours of all parties as well as how they react to other parties' behaviours.
...
The use-case of representing complex abstractions in a machine-readable formats is a common one, and general-purpose programming languages (Java, Python, etc) are designed with exactly this goal in mind.

According to~\cite{fowlerDsl}: "A DSL is a computer language that's targeted to a particular kind of problem, rather than a general purpose language that's aimed at any kind of software problem".
