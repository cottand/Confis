...
\begin{definition}[DSL Host Traits]
    ...
    Languages well-suited to be host for DSLs usually have some of the following language features:
    \begin{itemize}
...
Haskell~\cite{haskellDocs} is a functional programming language which can be compiled or used to interpret single files.
It has advanced features including all of the ones mentioned in~\nameref{def:host-lang-requirements}.
These are demonstrated in~\cite{haskellBasicDSL}.
