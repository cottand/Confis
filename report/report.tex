...
%\includegraphics{Logo} % University/department logo - uncomment to place it
    ...
    \begin{abstract}
        ...
        The notion of formalising contracts was first introduced by~\cite{szabo1997smart-contracts} in 1997, but at the time of writing (25 years later) in practice how we interact with legal agreements has remained largely unchanged -- they are rarely automated.
        ...
        This project introduces \textbf{\emph{Confis}}, an accessible language that formalises legal agreements and allows complex queries involving parties' legal capabilities and their compliance.
        The project includes a visual prototype for authoring, evaluating, and reading contracts which is engineered to be pragmatic and accessible.
        Its features include converting documents to legal prose, an intelligent editor with a live preview, and a user interface for performing complex queries on documents as they are written.

        Overall, this project aims to operationalise legal agreements by providing the industry with relevant and pragmatic tools.
