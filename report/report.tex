...
%\setlength{\parskip}{\medskipanount}
...
%\includegraphics{Logo} % University/department logo - uncomment to place it
    ...
    \begin{abstract}
        ...
        The notion of formalising contracts was first introduced by Szabo in~\cite{szabo1997smart-contracts} in 1997, but at the time of writing (25 years later) in practice how we interact with legal agreements has remained largely unchanged -- they are rarely automated.

        % not not automated, but still actually paper/plaintext

        % The point is to ahve a digital representation beyond plaintext
        ...
        This project introduces \textbf{\emph{Confis}}, an accessible language that specifies legal agreements and allows complex queries involving parties' legal capabilities and their compliance.
