...
%\includegraphics{Logo} % University/department logo - uncomment to place it
    ...
    \begin{abstract}
        ...
        % For more than 4 thousand years, humankind has utilised contracts to govern trades, bargains and exchanges // that stem from the converging wills of parties to conduct a trade, or a bargain. Since their conception in ancient times (sumeria, 4k times), their are represented as antural language and how we reason about them as remained unchanged, even though their are a main driver of economical activity and progress

        % For more than 4 thousand years, humankind has utilised contracts to govern economic activity.
        % Since their conception in ancient times (sumeria, 4k times), they have been represented as clauses of natural language and how we reason about them has remained unchanged, despite technological leaps.

        % In the last few decades, since the seminal work on smart contracts by Szabo, the benefits of formalising and automating contracts have become increasingly obvious.
        ...
        The notion of formalising contracts was first introduced by Szabo in 1997, but at the time of writing (25 years later) in practice how we interact with legal agreements has remained unchanged~-- we still represent their clauses in natural language and rely on human understanding to interpret them.
...
%        Its features include converting documents back to plain English, an intelligent editor with a live preview, and a user interface for performing complex queries on documents as they are written.
        ...
        A graphical UI allows making questions involving parties' legal capabilities and their compliance, such as \emph{`What needs to happen for my landlord evict me?'} or \emph{`Has the seller breached our agreement?'}
        ...
        The result is an end-to-end framework that provides abstractions that successfully represent most use-cases for contracts comparable to those of Symboleo or The Accord Project, except with a strong focus on accessibility and ease-of-use aimed at industry.
    ...
    \include{appendices/cryptoBackground}
